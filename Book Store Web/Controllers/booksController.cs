...
namespace Book_Store_Web.Controllers
{
    public class booksController : Controller
    {
        ...
        public booksController(Book_Store_WebContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.book != null ? 
                          ...
                          Problem("Entity set 'Book_Store_WebContext.book'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'Book_Store_WebContext.book'  is null.");
            }
            var book = await _context.book.FindAsync(id);
            if (book != null)
            {
